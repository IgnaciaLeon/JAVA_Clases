...
public class Funciones {
    public static void main(String[] args) {
        ...
        // protegido, etc, eso va a depender de un principio llamado "encapsulación".
        ...
        //Argumento: cuando uno ya llama a lo que va dentro de la función pasa de llamarse parámetro a argumento.
        //Las funciones son iguales a los métodos, con la única diferencia de que el método le pertenece a una clase.

        //EJ FUNCIÓN 1
        String miNombre = "Ignacia";
        System.out.println(miNombre);
        //en vez de hacer esto cuando queramos imprimir muchos valores, podemos crear una funcion, como la de la línea 43
    ...
    //Recordar que la función siempre irá fuera de Main. Y cuando llamemos a la función porque queremos utilizarla debemos
    //hacerlo dentro de main.
